...
const MenuButton = ({ onClick, isOpen }) => {
  return (
    <motion.button onClick={onClick} className="cursor-pointer sm:hidden p-2 flex items-end justify-end" initial={false} animate={isOpen ? "open" : "closed"}>
      <motion.svg width="28" height="28" viewBox="0 0 24 24" stroke="white" strokeWidth="2.5" strokeLinecap="round">
        {/* Top Line */}
