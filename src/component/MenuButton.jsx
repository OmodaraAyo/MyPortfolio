...
const MenuButton = ({ onClick, isOpen }) => {
  return (
    <motion.button type="button" onClick={onClick} className="cursor-pointer sm:hidden p-2 flex items-end justify-end z-100" initial={false} animate={isOpen ? "open" : "closed"} aria-label="open menu">
