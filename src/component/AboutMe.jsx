...
const AboutMe = () => {
  ...
  return (
    <section className="container mx-auto px-4" id='aboutme'>
    <div className="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-5">

      {/* Text Content */}
      <div className="text-center md:text-left space-y-1 text-black flex flex-col justify-center items-center md:items-start py-3">
